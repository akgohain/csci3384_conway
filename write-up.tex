...
\end{enumerate}
\section{Pattern Reachability}
Now that we have built out the formal definition of \textbf{GoL}, let's analyze PERN's complexity. To begin, lets now pose PERN more formally as the following: \\
