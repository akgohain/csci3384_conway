...
Because of this, there are over a thousand different patterns that have been proposed and studied within the game \cite{Life_Wiki}. Of these many patterns, there are three notable characteristics that are used to categorize and study them. There are as follows: 
...
\begin{enumerate}
  ...
  \item \textbf{Spaceship: } \\ A pattern that returns to its initial phase after it completes its period, but ends in a different location from where it started.
\end{enumerate}
