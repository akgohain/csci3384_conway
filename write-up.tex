...
\end{enumerate}
 ...
 \begin{figure}[ht]
          \centering
    \includegraphics[width=10cm]{figure_one.png}
...
We say a  Language \textbf{L} $\in$ \textbf{NP} if there exists a polynomial-time TM that can verify \textbf{PREP}'s certificate efficiently. Let's begin by constructing a certificate by nondeterministicically guessing the solution to \textbf{PREP}.
